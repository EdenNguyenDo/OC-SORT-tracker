            ...
            if n_frame > n_min:
                ...
                for frame in frames:
                    if frame not in to_fill_frames:
                        ...
                        curr_x = scaler_x.inverse_transform(curr_x.reshape(-1, 1))
                        curr_y = scaler_y.inverse_transform(curr_y.reshape(-1, 1))
                        curr_bbox = np.array([[curr_x.item() - 0.5 * width, curr_y.item() - 0.5 * height,
...
if __name__ == "__main__":
    ...
    """
    save_path = "C:/transmetric/dev/python/AI_camera/trial/OC_SORT-master/tracks/067-00007_Wed_Thur_27hrs_1500_interpolate/2024_1204_154045_002A_GPR"
    li_path = "C:/transmetric/dev/python/AI_camera/trial/OC_SORT-master/tracks/067-00007_Wed_Thur_27hrs_1500_interpolate"
    track_path = "/saved_svg/067-00007_Wed_Thur_27hrs_1500/2024_1204_154045_002A"
    mkdir_if_missing(save_path)
    gp_interpolation(track_path, save_path, li_path, n_min=10, n_dti=50)