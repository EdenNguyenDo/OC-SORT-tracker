...
def make_parser():
    ...
    parser.add_argument("--conf", default=0.12, type=float, help="test conf")
    ...
    parser.add_argument('--asso', default="giou", help="similarity function: iou/giou/diou/ciou/ctdis")
    ...
    parser.add_argument( "--path", default="./videos/dance_demo.mp4", help="path to images or video")
    ...
    parser.add_argument(
        "--aspect_ratio_thresh", type=float, default=1.5,
        help="threshold for filtering out boxes of which aspect ratio are above the given value."
    )
    parser.add_argument('--min_box_area', type=float, default=8, help='filter out tiny boxes')
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
